...
\tadOperacion{disputan}{teg/t,casillero/c}{conj(jugador)}{$disputado(t,c)$}
%%%%%%%%%%%% OPERACIONES AUXILIARES AGREGAR UN COMENTARIO
...
\tadOperacion{jugadoresVivos}{teg/t,conj(jugador)/jugadores}{conj(jugador)}{}
...
\tadAxioma{\#fichasTotales(iniciar(t,jugadores,posIniciales,misiones))}{0}
...
\tadAxioma{unicoJugadorVivo?(t)}{\#(jugadoresVivos(t,jugadores(t)))=1}
\tadAxioma{unicoJugadorVivo(t)}{dameUno(jugadoresVivos(t,jugadores(t)))}
\tadAxioma{jugadoresVivos(t,jugs)}{jugadores(t) - eliminados(t)}
